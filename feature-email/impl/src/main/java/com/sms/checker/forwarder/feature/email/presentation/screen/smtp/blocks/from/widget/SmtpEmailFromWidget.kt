package com.sms.checker.forwarder.feature.email.presentation.screen.smtp.blocks.from.widget
...
@Composable
internal fun SmtpEmailFromWidget(
    modifier: Modifier = Modifier,
    state: SmtpEmailFromState,
    action: SmtpEmailFromAction,
) {
    Column(
        ...
        FieldWidget(
            ...
            onValueChange = action.onChangeName,
        )
    }
}